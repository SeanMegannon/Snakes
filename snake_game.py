...
def draw_gradient_background(screen):
    for y in range(GRID_PIXEL_HEIGHT):
        r = int((y / GRID_PIXEL_HEIGHT) * (DARK_BLUE[0] - BLACK[0]) + BLACK[0])
        g = int((y / GRID_PIXEL_HEIGHT) * (DARK_BLUE[1] - BLACK[1]) + BLACK[1])
        b = int((y / GRID_PIXEL_HEIGHT) * (DARK_BLUE[2] - BLACK[2]) + BLACK[2])
        color = (r, g, b)
